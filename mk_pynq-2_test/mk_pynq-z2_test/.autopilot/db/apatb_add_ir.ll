; ModuleID = 'C:/Users/user/Desktop/ADD_TEST/mk_pynq-2_test/mk_pynq-z2_test/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline
define void @apatb_add_ir(i32 %a, i32 %b, i32* %c) local_unnamed_addr #0 {
entry:
  %c_copy = alloca i32, align 512
  call fastcc void @copy_in(i32* %c, i32* nonnull align 512 %c_copy)
  call void @apatb_add_hw(i32 %a, i32 %b, i32* %c_copy)
  call fastcc void @copy_out(i32* %c, i32* nonnull align 512 %c_copy)
  ret void
}
...
define void @add_hw_stub_wrapper(i32, i32, i32*) #5 {
entry:
